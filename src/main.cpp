...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (int i = 0; i < 10; i++){
            ...
            model = glm::translate(model, glm::vec3(sin(glfwGetTime()), 0, 0) + cubePositions[i]);
            model = glm::rotate(model, glm::radians((float)glfwGetTime()*100), glm::vec3(cos(glfwGetTime()), sin(glfwGetTime()), 0.0f));
